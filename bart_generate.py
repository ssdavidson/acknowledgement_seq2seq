...
def generate_summaries(
    ...
    for batch in tqdm(list(chunks(examples, batch_size))):
        dct = tokenizer.batch_encode_plus(batch, max_length=128, return_tensors="pt", pad_to_max_length=True)
        ...
        summaries = model.generate(
            ...
            max_length=15,  # +2 from original because we start at step=1 and stop before max_length
